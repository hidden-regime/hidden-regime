...
def main():
    ...
    try:
        ...
        print("❌ Missing matplotlib/seaborn. Install with: pip install matplotlib seaborn")
        return
    ...
    try:
        ...
        regimes = np.random.choice([0, 1, 2], n_days, p=[0.3, 0.4, 0.3])  # bear, sideways, bull
        returns = []
    ...
    plt.suptitle('Hidden Markov Model - Regime Analysis', fontsize=16, fontweight='bold', y=0.96)
    plt.show()
    ...
    plt.suptitle('Regime State Analysis & Validation', fontsize=16, fontweight='bold', y=0.95)
    plt.show()
    ...
    print()
    print("💡 Next steps:")
    print("   • Try with your own data: loader.load_stock_data('YOUR_TICKER', start, end)")
    print("   • Experiment with different regime configurations (3_state, 4_state, 5_state)")
