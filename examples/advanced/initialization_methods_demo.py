...
# Use factory to create model component (recommended approach)
hmm_kmeans = component_factory.create_model_component(kmeans_config)
...
print(f"Training on {len(spy_data)} days of SPY data...")
# Use factory to create model component
hmm_random = component_factory.create_model_component(random_config)
...
# Use factory to create model component
hmm_custom = component_factory.create_model_component(custom_config)
...
# Use factory to create model component
hmm_factory = component_factory.create_model_component(factory_config)
...
# Use factory to create model component
hmm_transfer = component_factory.create_model_component(transfer_config)
