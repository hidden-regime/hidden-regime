...
from hidden_regime.models.utils import validate_regime_economics, analyze_regime_transitions
...
def load_realistic_market_data():
    ...
    market_periods = [
        # Bull market
        {'start': '2018-01-01', 'end': '2019-12-31', 'regime': 'bull', 
         'mean': 0.0008, 'std': 0.014, 'description': 'Bull Market 2018-2019'},
        ...
        # Recovery
        {'start': '2020-05-01', 'end': '2021-12-31', 'regime': 'bull',
         'mean': 0.0012, 'std': 0.020, 'description': 'COVID Recovery'}
    ]
...
def validate_regimes(hmm, market_data):
    ...
    for period in unique_periods:
        ...
        print(f"     Predicted: {regime_name} (conf: {dominant_confidence:.2f}) {match}")
...
def main():
    ...
    try:
        ...
        print(f"\nKey Results:")
        print(f"- Configuration: {best_hmm.config.regime_type} with {best_hmm.n_states} states")
