    ...
    try:
        ...
        for ticker in ALL_TICKERS:
            try:
                ...
                # Use factory to create components (recommended)
                ...
                # Create observations using factory
                ...
                # Run HMM analysis using factory
                hmm_config = HMMConfig(
                    n_states=3, max_iterations=100, tolerance=1e-4, random_seed=42
                )
                hmm = component_factory.create_model_component(hmm_config)
