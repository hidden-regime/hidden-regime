...
class TestDataValidator:
    ...
    def test_validate_date_range_valid(self):
        ...
        is_valid, issues = self.validator.validate_date_range("2023-01-01", "2023-12-31")
    ...
    def test_validate_date_range_invalid(self):
        ...
        # Start after end
        is_valid, issues = self.validator.validate_date_range("2023-12-31", "2023-01-01")
        ...
        # Very short range
        is_valid, issues = self.validator.validate_date_range("2023-01-01", "2023-01-03")
        assert is_valid == False
    ...
    def test_validate_missing_data_good(self):
        ...
        issues, warnings, metrics = self.validator._validate_missing_data(self.good_data)
    ...
    def test_validate_missing_data_excessive(self):
        ...
        issues, warnings, metrics = self.validator._validate_missing_data(data_with_missing)
    ...
    def test_detect_outliers_many_outliers(self):
        ...
        data_with_outliers.loc[extreme_indices, 'log_return'] = np.random.uniform(-0.2, 0.2, 20)
    ...
    def test_find_max_consecutive_missing(self):
        ...
        series_with_gaps = pd.Series([1, 2, np.nan, np.nan, np.nan, 6, 7, np.nan, 9, np.nan])
    ...
    def test_find_max_consecutive_missing_no_missing(self):
        ...
        max_consecutive = self.validator._find_max_consecutive_missing(series_no_missing)
    ...
    def test_validate_data_comprehensive_invalid_scenarios(self):
        ...
        for scenario_name, invalid_data in self.invalid_data_scenarios.items():
            ...
            result = self.validator.validate_data(invalid_data, ticker=f"TEST_{scenario_name}")
            
            # All invalid scenarios should have issues or low quality scores
            assert (not result.is_valid) or (result.quality_score < 0.7), \
