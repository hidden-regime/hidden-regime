...
class TestHMMUtils:
    ...
    def test_initialize_parameters_random(self, sample_returns):
        ...
        initial_probs, transition_matrix, emission_params = initialize_parameters_random(
            n_states, sample_returns, random_seed=42
        )
        ...
        initial_probs2, transition_matrix2, emission_params2 = initialize_parameters_random(
            n_states, sample_returns, random_seed=42
        )
    ...
    def test_initialize_parameters_kmeans_insufficient_data(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            initial_probs, transition_matrix, emission_params = initialize_parameters_kmeans(
                n_states, small_data, random_seed=42
            )
    ...
    def test_initialize_parameters_kmeans_failure(self, mock_kmeans, sample_returns):
        ...
        mock_kmeans.return_value.fit_predict.side_effect = Exception("Clustering failed")
    ...
    def test_check_convergence_converged(self):
        ...
        converged_history = [-100.0, -90.0, -85.0, -82.0, -81.0, -80.99, 
                           -80.98, -80.97, -80.96, -80.959, -80.958, -80.957]
    ...
    def test_check_convergence_not_converged(self):
        ...
        not_converged_history = [-100.0, -90.0, -80.0, -70.0, -60.0, -50.0, 
                               -40.0, -30.0, -20.0, -10.0, -5.0, -2.0]
        
        result = check_convergence(not_converged_history, tolerance=1e-6, min_iterations=10)
        assert result is False
    ...
    def test_validate_hmm_parameters_invalid_initial(self):
        ...
        with pytest.raises(ValueError, match="Initial probabilities must be non-negative"):
            validate_hmm_parameters(initial_probs, transition_matrix, emission_params)
    ...
    def test_validate_hmm_parameters_invalid_transition(self):
        ...
        transition_matrix = np.array([
            [1.1, -0.1],  # Sums to 1.0 but has negative value
            [0.4, 0.6]
        ])
        
        with pytest.raises(ValueError, match="Transition probabilities must be non-negative"):
            validate_hmm_parameters(initial_probs, transition_matrix, emission_params)
    ...
    def test_validate_hmm_parameters_invalid_emission(self):
        ...
        with pytest.raises(ValueError, match="Emission standard deviations must be positive"):
            validate_hmm_parameters(initial_probs, transition_matrix, emission_params)
    ...
    def test_calculate_regime_statistics(self):
        ...
        returns = np.array([-0.02, -0.01, 0.005, 0.001, 0.002, 0.01, 0.012, -0.015, -0.008])
