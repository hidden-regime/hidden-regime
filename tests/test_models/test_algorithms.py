...
class TestHMMAlgorithms:
    ...
    def test_baum_welch_update(self, sample_observations, simple_hmm_params):
        ...
        # Update parameters
        new_initial_probs, new_transition_matrix, new_emission_params = HMMAlgorithms.baum_welch_update(
    ...
    def test_predict_next_state_probs(self, simple_hmm_params):
        ...
        next_probs = HMMAlgorithms.predict_next_state_probs(current_probs, transition_matrix)
    ...
    def test_consistency_forward_backward_viterbi(self, sample_observations, simple_hmm_params):
        ...
        assert viterbi_log_prob <= fb_log_likelihood + 1e-10  # Small tolerance for numerical precision
