...
class TestHMMConfig:
    ...
    def test_parameter_validation(self):
        ...
        with pytest.raises(ValueError, match="Minimum regime duration must be at least 1"):
        ...
        with pytest.raises(ValueError, match="Convergence check frequency must be positive"):
    ...
    def test_initialization_method_validation(self):
        ...
        assert config.initialization_method == 'invalid'  # Type hint but no runtime validation