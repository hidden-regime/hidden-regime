...
class HMMConfig:
    ...
    @classmethod
    def for_standardized_regimes(cls, regime_type: Literal['3_state', '4_state', '5_state'] = '3_state',
                               conservative: bool = False) -> 'HMMConfig':
        """
    ...
    @classmethod
    def with_auto_selection(cls, validation_threshold: float = 0.7,
                          conservative: bool = False) -> 'HMMConfig':
        """
